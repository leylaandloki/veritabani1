...
-- ffutbolcu10a için veritabanı yapısı dökülüyor
CREATE DATABASE IF NOT EXISTS `ffutbolcu10a` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `ffutbolcu10a`;

-- tablo yapısı dökülüyor ffutbolcu10a.fubolcu
CREATE TABLE IF NOT EXISTS `fubolcu` (
...
-- ffutbolcu10a.fubolcu: ~0 rows (yaklaşık) tablosu için veriler indiriliyor
/*!40000 ALTER TABLE `fubolcu` DISABLE KEYS */;
/*!40000 ALTER TABLE `fubolcu` ENABLE KEYS */;

-- tablo yapısı dökülüyor ffutbolcu10a.mevki
...
-- ffutbolcu10a.mevki: ~0 rows (yaklaşık) tablosu için veriler indiriliyor
/*!40000 ALTER TABLE `mevki` DISABLE KEYS */;
/*!40000 ALTER TABLE `mevki` ENABLE KEYS */;

-- tablo yapısı dökülüyor ffutbolcu10a.takim
...
-- ffutbolcu10a.takim: ~0 rows (yaklaşık) tablosu için veriler indiriliyor
